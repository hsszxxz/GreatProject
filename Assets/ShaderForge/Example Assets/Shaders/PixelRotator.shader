...
////// Emissive:
                ...
                float4 node_9564 = _Time;
                float node_563_ang = node_9564.g;
                float node_563_spd = 10.0;
                ...
                float node_747 = (1.0 - floor(saturate(length((float2(1,3)*node_563)))));
                float3 emissive = (pow(float3(float2(node_737,node_739),node_741),2.0)*node_747);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,node_747);
